...
Para avaliar as duas maneiras de implantação desta aplicação na AWS Lambda, esta tiveram configurações distintas. Uma na qual foi gerado um arquivo executável JAR e compactado a pasta em formato ZIP. A outra foi feita com um arquivo adicional Dockerfile, para gerar um \texit{build} da imagem em contêiner.
